...
|---|---:|---:|---:|
| NSE | 0.8890 | 0.8983 | -0.0093 |
| RMSE | 0.801 | 0.767 | +0.034 |
| MAE | 0.075 | 0.088 | -0.013 |
| peak_err_pct | +6.6 | +4.7 | +2.0 |
| recall@50 | 0.652 | 0.783 | -0.130 |
| recall@25 | 0.842 | 0.895 | -0.053 |
| n_params | 23,489 | 89,985 | -66,496 |
| training_time_s | 967 | ~1117 (iter19) | n/a |
| best_epoch | 14 | 18 | n/a |

## Tabla comparativa por bucket en test

| Bucket | n | NSE A0 | NSE A4 | dNSE | bias A0 | bias A4 | dbias | pico% A0 | pico% A4 | dpico% |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Base | 152900 | +0.732 | +0.085 | +0.646 | -0.002 | +0.002 | -0.004 | +796.6 | +1371.2 | -574.6 |
| Leve | 9520 | +0.870 | +0.765 | +0.106 | +0.010 | +0.136 | -0.126 | +106.0 | +150.6 | -44.6 |
| Moderado | 2303 | +0.582 | +0.527 | +0.055 | -0.227 | +0.350 | -0.577 | +99.4 | +135.8 | -36.4 |
| Alto | 440 | -0.202 | +0.005 | -0.207 | -2.661 | -1.045 | -1.617 | +16.0 | +20.7 | -4.7 |
| Extremo | 59 | -1.571 | -1.231 | -0.340 | -18.753 | -13.739 | -5.015 | +6.6 | +4.7 | +2.0 |

## Lectura de los resultados

**Hipotesis del bucket Extremo (A0 mejor que A4 en eventos criticos)**: **no confirma** la hipotesis. NSE_extremo A0 = -1.571 <= A4 = -1.231 (-0.340); |bias_extremo| A0 = 18.753 >= A4 = 13.739. 
...
- delta NSE global (A0 - A4) = -0.0093
- delta peak_err_pct (A0 - A4) = +2.0
- delta NSE_extremo (A0 - A4) = -0.340
- delta bias_extremo (A0 - A4) = -5.015 MGD
- delta peak_err_pct_extremo (A0 - A4) = +2.0
- delta NSE_alto (A0 - A4) = -0.207
